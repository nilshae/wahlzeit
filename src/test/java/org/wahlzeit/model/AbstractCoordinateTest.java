...
public class AbstractCoordinateTest {
    ...
    public void testIsEqualSphericalCoordinates() {
        Coordinate coordinate1 = SphericalCoordinate.getInstance(50.2064932, -117.1873205, 6371);
        Coordinate coordinate2 = SphericalCoordinate.getInstance(50.2064932, -117.1873205, 6371);
    ...
    public void testIsEqualDifferentTypes() {
        ...
        Coordinate coordinate2 = SphericalCoordinate.getInstance(0, 0, 6371);
    ...
    public void testGetDistanceSphericalCoordinates() {
        Coordinate coordinate1 = SphericalCoordinate.getInstance(50.2064932, -117.1873205, 6371);
        Coordinate coordinate2 = SphericalCoordinate.getInstance(50.2064932, -117.2373205, 6371);
    ...
    public void testGetDistanceSameLocation() {
        Coordinate coordinate1 = SphericalCoordinate.getInstance(1.0, 1.0, 6371);
        SphericalCoordinate coordinate2 = SphericalCoordinate.getInstance(1.0, 1.0, 6371);
    ...
    public void testGetDistanceCommutative() {
        SphericalCoordinate coordinate1 = SphericalCoordinate.getInstance(1.0, 1.0, 6371);
        SphericalCoordinate coordinate2 = SphericalCoordinate.getInstance(50.0, 1.0, 6371);
